      ...
      <main>
        <section className="mx-auto max-w-6xl px-6 pt-20 pb-24">
          ...
          <p className="mt-4 text-xs text-ink/50">
            ...
            is 0%. Payouts to makers are coordinated separately (no connected
        ...
        <section className="mx-auto max-w-6xl px-6 py-20">
          ...
          <ol className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8 text-sm">
            {[
              ...
              ["3", "Buyers order & pay", "Card payment via platform Stripe Checkout (Stockroom is MoR). You get an order notification."],
